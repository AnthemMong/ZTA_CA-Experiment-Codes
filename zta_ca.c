//2020-10-03
//compile: gcc zat_ca.c -lmiracl -o zta_ca
...
int main(int argc, char* argv[])
{
    ...
    unsigned char randstra1[BIGBYTE ];
    unsigned char randstra2[BIGBYTE];
    unsigned char xortemp[BIGBYTE];
    unsigned char idastr[BIGBYTE];
    unsigned char tkastr[BIGBYTE];
    unsigned char CMa[BIGBYTE];
    unsigned char CAa[BIGBYTE];
    ...
    unsigned char randstrg1[BIGBYTE];
    unsigned char randstrg2[BIGBYTE];
    unsigned char ra2p[BIGBYTE];
    //unsigned char xortemp[BIGBYTE];
    unsigned char idgstr[BIGBYTE];
    unsigned char tkgstr[BIGBYTE];
    unsigned char CMg[BIGBYTE];
    unsigned char CAg[BIGBYTE];
    unsigned char CAap[BIGBYTE];
    ...
    unsigned char rg2p[BIGBYTE];
    unsigned char CAgp[BIGBYTE];
